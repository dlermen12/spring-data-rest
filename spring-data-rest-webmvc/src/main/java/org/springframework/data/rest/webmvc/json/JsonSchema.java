...
public class JsonSchema {
    ...
    public static class JsonSchemaProperty extends AbstractJsonSchemaProperty<JsonSchemaProperty> {
        ...
        public JsonSchemaProperty withMaximum(Long maximum) {
            this.maximum = maximum;
            return this;
        }

        public JsonSchemaProperty withMinimum(Long minimum) {
            this.minimum = minimum;
            return this;
        }

        public JsonSchemaProperty withMaxLength(Long maxLength) {
            this.maxLength = maxLength;
            return this;
        }

        public JsonSchemaProperty withMinLength(Long minLength) {
